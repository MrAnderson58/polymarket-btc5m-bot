...
SERVICES: tuple[ManagedService, ...] = (
    ...
    ManagedService(
        key="news-intel",
        label="news-intel",
        module_args=("-m", "bot.research.market_events", "news-intel-worker"),
        log_name="news-intelligence.log",
    ...
    ManagedService(
        key="multi-source",
        label="multi-source",
        module_args=("-m", "bot.research.market_events", "multi-source-run"),
        log_name="multi-source.log",
        markers=("bot.research.market_events multi-source-run",),
    ),
    ManagedService(
